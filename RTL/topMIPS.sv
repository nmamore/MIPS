...
assign reg_wr_data = (reg_wr_data_src) ? data_mem_rd_dat: //Set register write data to data memory output
...
assign pc_in = pc_out + 32'h00000004; //Addresses are word aligned
